...
function Sponsor(){
    ...
    return(
        ...
        <div className="container mx-auto justify-center items-center flex flex-col py-16 gap-6">
            <h1 className="font-medium text-3xl ">Powered By :</h1>
            <div className="brand w-full overflow-hidden">
                <div id="brand-container" className="brand-item flex items-center animate-scroll space-x-48">
